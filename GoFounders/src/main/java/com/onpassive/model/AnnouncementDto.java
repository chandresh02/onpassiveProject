...
public class AnnouncementDto implements Serializable {
	...
	public String toString() {
		return "AnnouncementDto [announce_id=" + announce_id + ", announce_name=" + announce_name
				+ ", announce_content=" + announce_content + ", files=" + files + ", poster=" + poster + ", dates="
				+ dates + ", viewid=" + viewid + ", date_s=" + date_s + "]";
	}
