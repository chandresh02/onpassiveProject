...
<title> Marketing | GoFounders</title>
...
<body  class="marketing user_body">  
    <!-- Sidenav -->
                ...
                <div class="container-fluid">
                      ...
                      <!-- Brand -->
                       ...
                       <div class="navbar-wrapper">
                            <a class="navbar-brand text-white">Marketing</a>
                       </div>
...
<div class="container-fluid" style="">
    ...
    <div class="row">
        <div class="col-12 mt-3">
                                                                    ...
                                                                    <div class="post-boxes pb-5 text-center">
                                        ...
                                        <span class="date"> Date:
                                            ...
                                            <h2>
                                                ...
                                                <h2>-- COMING SOON! Check Later                                             </h2>
                                                                                                                                    <video id="my-video" class="video-js video-size w-70" controls preload="auto"
                                                style="width:100%" data-setup="{}">
                                                <source src="https://d1iy5wifs53qnq.cloudfront.net/OnPassive_Cinematic_Trailer_Final.mp4" type='video/mp4'>
                                                <p class="vjs-no-js">
