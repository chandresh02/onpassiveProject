                ...
                <div class="container-fluid">
                      ...
                      <!-- Brand -->
                       ...
                       <div class="navbar-wrapper">
                            <a class="navbar-brand text-white">invitees</a>
                       </div>
          ...
          <div class="card shadow">
           ...
           <div class="container mt-3">
            ...
            <div class="row justify-content-betweeen">
                <div class="col-lg-4">
              <a href="#/invitees/webinar_invitees/?info=10" class="btn-block btn btn-primary"> 
                   Webinar Invitees 
                   <i class="material-icons">people_outline</i>
               </a>
               </div>
             <div class="col-lg-4">
             <a class="btn btn-info btn-block" href="#" data-toggle="modal" data-target="#myModal_a">
                Broadcast 
            ...
            <div class="col-lg-4">
             ...
             <div class="row my-3 justify-content-between align-items-end">
                ...
                <div class="col-lg-6">
                                 ...
                                 <form action="http://3.215.252.44/invitees/search_invitees"
                                     method="post">
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-footer">
            <a href="http://3.215.252.44/invitees/delinvitees/NzU3MDE=" ><button type="button" class="btn btn-danger" >Yes delete it!</button></a>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body pt-5">
         ...
         <div class="">      
                        ...
                        <form method="post" action="http://3.215.252.44/invitees/inviteemail" enctype="multipart/form-data" onsubmit="return validateBadText1();">
   ...
   var replace_with_str = "";
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-footer">
            <a href="http://3.215.252.44/invitees/delinvitees/NzIyNjA=" ><button type="button" class="btn btn-danger" >Yes delete it!</button></a>
          <button type="button" class="btn btn-default" data-dismiss="modal">No</button>
        </div>
      </div>
    </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body pt-5">
         ...
         <div class="">      
                        ...
                        <form method="post" action="http://3.215.252.44/invitees/inviteemail" enctype="multipart/form-data" onsubmit="return validateBadText2();">
   ...
   var replace_with_str = "";
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-footer">
            <a href="http://3.215.252.44/invitees/delinvitees/NzE1ODU=" ><button type="button" class="btn btn-danger" >Yes delete it!</button></a>
          <button type="button" class="btn btn-default" data-dismiss="modal">No</button>
        </div>
      </div>
    </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body pt-5">
         ...
         <div class="">      
                        ...
                        <form method="post" action="http://3.215.252.44/invitees/inviteemail" enctype="multipart/form-data" onsubmit="return validateBadText3();">
   ...
   var replace_with_str = "";
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-footer">
            <a href="http://3.215.252.44/invitees/delinvitees/NDYzNzQ=" ><button type="button" class="btn btn-danger" >Yes delete it!</button></a>
          <button type="button" class="btn btn-default" data-dismiss="modal">No</button>
        </div>
      </div>
    </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body pt-5">
         ...
         <div class="">      
                        ...
                        <form method="post" action="http://3.215.252.44/invitees/inviteemail" enctype="multipart/form-data" onsubmit="return validateBadText4();">
...
<script>
  ...
  $(document).ready(function(){
   ...
   var replace_with_str = "";
    ...
    font-weight: 600;
    text-transform: capitalize;"> showing  from  1  to 4 of 4</p>
      ...
      <div class="modal-content">
        ...
        <button type="button" class="close" data-dismiss="modal">&times;</button>
         ...
         <div class="">
                                           ...
                                           <form method="post" action="http://3.215.252.44/invitees/broadcast" enctype="multipart/form-data" onsubmit="return validateBadText();">

                                <!--Body-->

                                        <input type="hidden" class="form-control" id="email1" name="email1" value="nadarnikesh@gmail.com,tanmoy@inventiotechnologies.com,subarnamaitra8@gmail.com,saikatbose1234@gmail.com" >
                                 ...
                                 <input type="hidden" class="form-control"  name="date" value="2019/09/10" required=""  >
...
<script>
 ...
 <script>
        function Export()
        {
                ...
                window.open("http://3.215.252.44/invitees/inviteescsv", '_blank');
   ...
   <script type="text/javascript">
     ...
     $(document).ready(function(){ 
           ...
           $('#limitval').on('change', function(){
            ...
            window.location.href='http://3.215.252.44/invitees/index/?info='+val;
  ...
  <div class="modal fade" id="spammodal" role="dialog">
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h3 class="modal-title mt-0">Spam Words</h3 >
        </div>
