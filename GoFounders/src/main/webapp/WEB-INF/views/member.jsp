...
<title> My Team | GoFounders</title>
                ...
                <div class="container-fluid">
                      ...
                      <!-- Brand -->
                       ...
                       <div class="navbar-wrapper">
                            <a class="navbar-brand text-white">My Team</a>
                       </div>
        ...
        <div class="col-12">
          <div class="card shadow">
            ...
            <div class="container mt-3">
             ...
             <p align="right" class="member-p">
             <a href="#"  style="padding: 0px;" class="first d-inline-block" >
                 <button class="btn btn-primary frm_top_btn frm_top_btn_first"> Pending Founders 
                    <span class="material-icons">supervisor_account</span>
                 </button>
             </a>
             <a href="#" data-toggle="modal" data-target="#myModal_b" style="padding: 0px;" class="second d-inline-block" >
                 <button class="btn btn-info frm_top_btn frm_top_btn_mid" > 
                     Broadcast 
                     <span class="material-icons">email</span>
                 </button>
             </a>
             <a href="#" style="padding: 0px;" class="thired d-inline-block" >
             <button data-toggle="modal" data-target="#myModal00" class="btn btn-warning frm_top_btn frm_top_btn_last" >
                 Export CSV File 
               ...
               <div class="col-lg-6">
                                 ...
                                 <form action="http://3.215.252.44/member/search_member"
                                     method="post">
                                     ...
                                     <div class="input-group">
                                         ...
                                         placeholder="" name="search_val" required>

                                         <button class="btn btn-primary m-0 btn-round btn-just-icon" type="submit" id="btn">
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h2 class="modal-title">Export My Team to CSV?</h2>
        </div>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-default" data-dismiss="modal">No</button>
           ...
           <div id="home" class="container tab-pane active"><br>
              ...
              <table class="table align-items-center table-flush member-t" id="">
                <thead class="thead-dark">
                    ...
                    <tr>
                      ...
                      <th scope="col">No. Of Founders</th>
                ...
                <tbody>
                    ...
                    <td> <a href="#" data-toggle="modal" data-target="#myModal1" > <i titile="Email" class="fa fa-envelope" style="font-size:24px"></i></a>
                    </td>
                  </tr>
                  <!-- Modal -->
                            ...
                            <div class="modal-content">
                              ...
                              <button type="button" class="close" data-dismiss="modal">&times;</button>
                               ...
                               <div class="">
                                ...
                                <form method="post" action="http://3.215.252.44/member/membermail" enctype="multipart/form-data" onsubmit="return validateBadText1();">
                                <!--Body-->
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="text" class="form-control" id="name" value="Ankur Patel" name="name" readonly >
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group-text"><i class="fa fa-book text-info"></i></div>
                                        ...
                                        <input type="text" class="form-control" id="sub" placeholder="Subject" value="New Message For Ankur Patel" name="sub" readonly >
                                    </div>
                                </div>
                                
                                   
                                <input type="hidden" class="form-control" id="email" name="email" value=" ankurptl3@gmail.com" >
   ...
   var replace_with_str = "";
    ...
    $('#spam_cont_id1').html(mail_template_content);
      ...
      $('#email_temp_spam_id1').modal('show');
                    ...
                    <td>
                      <div class="td-email">
                         redteamsoftwares@gmail.com                      </div>
                    </td>
                    <td>
                      9876543210                    </td>
                     <td>
                    ...
                    <td> <a href="#" data-toggle="modal" data-target="#myModal2" > <i titile="Email" class="fa fa-envelope" style="font-size:24px"></i></a>
                    </td>
                  </tr>
                  <!-- Modal -->
                            ...
                            <div class="modal-content">
                              ...
                              <button type="button" class="close" data-dismiss="modal">&times;</button>
                               ...
                               <div class="">
                                ...
                                <form method="post" action="http://3.215.252.44/member/membermail" enctype="multipart/form-data" onsubmit="return validateBadText2();">
                                <!--Body-->
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                        <div class="input-group-prepend">
                                        ...
                                        <input type="text" class="form-control" id="name" value="Ayush Sharma" name="name" readonly >
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group-text"><i class="fa fa-book text-info"></i></div>
                                        ...
                                        <input type="text" class="form-control" id="sub" placeholder="Subject" value="New Message For Ayush Sharma" name="sub" readonly >
                                    </div>
                                </div>
                                
                                   
                                <input type="hidden" class="form-control" id="email" name="email" value=" redteamsoftwares@gmail.com" >
   ...
   var replace_with_str = "";
    ...
    $('#spam_cont_id1').html(mail_template_content);
      ...
      $('#email_temp_spam_id1').modal('show');
                    ...
                    <td> <a href="#" data-toggle="modal" data-target="#myModal3" > <i titile="Email" class="fa fa-envelope" style="font-size:24px"></i></a>
                    </td>
                  </tr>
                  <!-- Modal -->
                            ...
                            <div class="modal-content">
                              ...
                              <button type="button" class="close" data-dismiss="modal">&times;</button>
                               ...
                               <div class="">
                                ...
                                <form method="post" action="http://3.215.252.44/member/membermail" enctype="multipart/form-data" onsubmit="return validateBadText3();">
                                <!--Body-->
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                        <div class="input-group-prepend">
                                ...
                                <input type="hidden" class="form-control" id="email" name="email" value=" paultanmoy.1992@yahoo.com" >
   ...
   var replace_with_str = "";
    ...
    $('#spam_cont_id1').html(mail_template_content);
      ...
      $('#email_temp_spam_id1').modal('show');
                    ...
                    <td> <a href="#" data-toggle="modal" data-target="#myModal4" > <i titile="Email" class="fa fa-envelope" style="font-size:24px"></i></a>
                    </td>
                  </tr>
                  <!-- Modal -->
                            ...
                            <div class="modal-content">
                              ...
                              <button type="button" class="close" data-dismiss="modal">&times;</button>
                               ...
                               <div class="">
                                ...
                                <form method="post" action="http://3.215.252.44/member/membermail" enctype="multipart/form-data" onsubmit="return validateBadText4();">
                                <!--Body-->
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                        <div class="input-group-prepend">
                                        ...
                                        <input type="text" class="form-control" id="name" value="Junaid Ahmed" name="name" readonly >
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group-text"><i class="fa fa-book text-info"></i></div>
                                        ...
                                        <input type="text" class="form-control" id="sub" placeholder="Subject" value="New Message For Junaid Ahmed" name="sub" readonly >
                                    </div>
                                </div>
                                
                                   
                                <input type="hidden" class="form-control" id="email" name="email" value=" jcrazy4sum1@gmail.com" >
   ...
   var replace_with_str = "";
    ...
    $('#spam_cont_id1').html(mail_template_content);
      ...
      $('#email_temp_spam_id1').modal('show');
                    ...
                    <td>
                      <div class="td-email">
                         amit@inventiotechnologies.com                      </div>
                    </td>
                    <td>
                      9876543210                    </td>
                     <td>
                    ...
                    <td> <a href="#" data-toggle="modal" data-target="#myModal5" > <i titile="Email" class="fa fa-envelope" style="font-size:24px"></i></a>
                    </td>
                  </tr>
                  <!-- Modal -->
                            ...
                            <div class="modal-content">
                              ...
                              <button type="button" class="close" data-dismiss="modal">&times;</button>
                               ...
                               <div class="">
                                ...
                                <form method="post" action="http://3.215.252.44/member/membermail" enctype="multipart/form-data" onsubmit="return validateBadText5();">
                                <!--Body-->
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                        <div class="input-group-prepend">
                                        ...
                                        <input type="text" class="form-control" id="name" value="Amit Bhar" name="name" readonly >
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group-text"><i class="fa fa-book text-info"></i></div>
                                        ...
                                        <input type="text" class="form-control" id="sub" placeholder="Subject" value="New Message For Amit Bhar" name="sub" readonly >
                                    </div>
                                </div>
                                
                                   
                                <input type="hidden" class="form-control" id="email" name="email" value=" amit@inventiotechnologies.com" >
   ...
   var replace_with_str = "";
    ...
    $('#spam_cont_id1').html(mail_template_content);
      ...
      $('#email_temp_spam_id1').modal('show');
                    ...
                    <td>
                      <div class="td-email">
                         saikat@inventiotechnologies.com                      </div>
                    </td>
                    <td>
                      8515928306                    </td>
                     <td>
                    ...
                    <td> <a href="#" data-toggle="modal" data-target="#myModal6" > <i titile="Email" class="fa fa-envelope" style="font-size:24px"></i></a>
                    </td>
                  </tr>
                  <!-- Modal -->
                            ...
                            <div class="modal-content">
                              ...
                              <button type="button" class="close" data-dismiss="modal">&times;</button>
                               ...
                               <div class="">
                                ...
                                <form method="post" action="http://3.215.252.44/member/membermail" enctype="multipart/form-data" onsubmit="return validateBadText6();">
                                <!--Body-->
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                        <div class="input-group-prepend">
                                ...
                                <input type="hidden" class="form-control" id="email" name="email" value=" saikat@inventiotechnologies.com" >
   ...
   var replace_with_str = "";
    ...
    $('#spam_cont_id1').html(mail_template_content);
      ...
      $('#email_temp_spam_id1').modal('show');
                    ...
                    <td>
                      <div class="td-email">
                         biki@inventiotechnologies.com                      </div>
                    </td>
                    <td>
                      9876543210                    </td>
                     <td>
                    ...
                    <td> <a href="#" data-toggle="modal" data-target="#myModal7" > <i titile="Email" class="fa fa-envelope" style="font-size:24px"></i></a>
                    </td>
                  </tr>
                  <!-- Modal -->
                            ...
                            <div class="modal-content">
                              ...
                              <button type="button" class="close" data-dismiss="modal">&times;</button>
                               ...
                               <div class="">
                                ...
                                <form method="post" action="http://3.215.252.44/member/membermail" enctype="multipart/form-data" onsubmit="return validateBadText7();">
                                <!--Body-->
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                        <div class="input-group-prepend">
                                        ...
                                        <input type="text" class="form-control" id="name" value="Biki Das" name="name" readonly >
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group-text"><i class="fa fa-book text-info"></i></div>
                                        ...
                                        <input type="text" class="form-control" id="sub" placeholder="Subject" value="New Message For Biki Das" name="sub" readonly >
                                    </div>
                                </div>
                                
                                   
                                <input type="hidden" class="form-control" id="email" name="email" value=" biki@inventiotechnologies.com" >
 ...
 <script>
  ...
  $(document).ready(function(){
   ...
   var replace_with_str = "";
    ...
    font-weight: 600;
    text-transform: capitalize;"> showing  from  1  to 7 of 7</p>
      ...
      <div class="modal-content">
        ...
        <button type="button" class="close" data-dismiss="modal">&times;</button>
         ...
         <div class="">
                                ...
                                <form method="post" action="http://3.215.252.44/member/broadcast1" enctype="multipart/form-data" onsubmit="return validateBadText();">
                                <!--Body-->
                            ...
                            <input type="hidden" class="form-control" id="email1" name="email1" value="ankurptl3@gmail.com,redteamsoftwares@gmail.com,paultanmoy.1992@yahoo.com,jcrazy4sum1@gmail.com,amit@inventiotechnologies.com,saikat@inventiotechnologies.com,biki@inventiotechnologies.com" >
 ...
 <script type="text/javascript">
  ...
  <script>
        function Export()
        {
                ...
                window.open("http://3.215.252.44/member/membercsv", '_blank');
 ...
 <script type="text/javascript">
     ...
     $(document).ready(function(){ 
           ...
           $('#limitval').on('change', function(){
            ...
            window.location.href='http://3.215.252.44/member/index/?info='+val;
  ...
  <div class="modal fade" id="spammodal" role="dialog">
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h3 class="modal-title mt-0 text-white">Spam Words</h3 >
        </div>
