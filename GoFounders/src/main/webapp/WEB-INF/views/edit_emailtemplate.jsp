                ...
                <div class="card-body">
                    <!--  <h2>Edit Email Templates</h2> -->
                     ...
                     <ul class="nav nav-tabs w-100 justify-content-between">
                       ...
                       <li class="nav-item">
                         <a class="nav-link" data-toggle="tab" href="#menu1">Edit Email Templates </a>
                       </li>
                      <li class="nav-item">
                         <a class="nav-link" href="#">Back To My Emailtemplate</a>
                       </li>
                     </ul>
                    </div>
                     <!-- Tab panes -->
                                 ...
                                 <form method="post" action="#" enctype="multipart/form-data" onsubmit="return validateBadText();">
                                     ...
                                     <div class="row">
                                       <div class="col-lg-12">
                                         ...
                                         <input type="text" class="form-control form-control-alternative" name="title" required="" value="test">
                                         </div>
                                       </div>
                                       <div class="col-lg-12">
                                         <div class="form-group focused">
                                            <h6 class="text-capitalize">Template Content</h6>
                                         
                               <textarea class="form-control form-control-alternative ckeditor" name="name" id="template_id_user" style="visibility: hidden; display: none;">&lt;p&gt;Rajesh and bappa&lt;/p&gt;
                               </textarea>
                                        ...
                                        <input type="hidden" name="emailid" value="739">
                                       
                                       <input type="submit" class="btn btn-primary" name="update" value="Update" style="margin-left: 20px;">
                                       &nbsp;
                   
                                        <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#spammodal">Spam content list</button>
                                     </div>
