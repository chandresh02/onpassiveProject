        ...
        <div class="row">
             ...
             <div class="col-12">
               <ul class="nav nav-tabs" role="tablist">
                   ...
                   <li class="nav-item">
                     <a class="nav-link " href="#recorded"  role="tab" data-toggle="tab">Recorded Webinars</a>
                  </li>                              
                 
                    <li class="nav-item">
                     <a class="nav-link active" href="#upcoming"  role="tab" data-toggle="tab"> Upcoming Webinars</a>
                  </li>
               ...
               <div class="tab-content mb-3">
 				 ...
 				 <div id="upcoming" class="tab-pane fade active" role="tabpanel">
                   ...
                   <c:forEach items="${recoredList}" var="upcomingWebinar">                         
                                          ...
                                          <h2>${upcomingWebinar.webinar_name}</h2> 
                                           ...
                                           <c:set var = "str1" value = "${fn:substringAfter(upcomingWbinar.files, '.')}" />
														
															<c:if test = "${not empty upcomingWebinar.files}">
															<c:if test = "${fn:substringAfter(upcomingWebinar.files, '.') == 'mp4'}">
																 	<video id="my-video" class="video-js video-size w-70"
																	controls preload="auto"
																	poster="https://d1iy5wifs53qnq.cloudfront.net/${upcomingWebinar.poster}"
																	data-setup="{}">
																	<source
																		src="https://d1iy5wifs53qnq.cloudfront.net/${upcomingWebinar.files}"
																		type='video/mp4'>
