...
<body  class="alfounders user_body">  
    <!-- Sidenav -->
        ...
        <div class="col-lg-8">
            ...
            <div class="tab-content mb-3"  >
                ...
                <div id="home" class="tab-pane active"><br>
                    ...
                    <table class="table table-striped al_founders" style="background: #fff;">

                        <thead class="bg-primary text-white font-weight-bold thead-dark">
                        ...
                        <tbody>
                           ...
                           <tr>
                            ...
                            <tr class="all-total-founder">

                                <td></td>

                                <td><h2 style="margin-left: -100px; color:#172b4d;">Total: 9 </h2></td>
...
<div class="col-12 text-center  pb-4 ">
    ...
    <div class="container">
       ...
       <h1 ><a href="allfounders" class="text-white btn mt-4 btn-primary team-summery-btn">Team Summary Details</a></h1>
