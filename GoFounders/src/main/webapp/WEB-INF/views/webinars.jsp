            ...
            <div class="col-12">
               <div class="tab-content mb-3">
                  ...
                  <div id="upcoming" class="tab-pane fade" role="tabpanel">
                                  ...
                                  <c:forEach items="${upcomingList}" var="upcomingWebinar">                                                
                                          <div class="webinars-post">
                                          <div class="webinars-post-title">
                      ...
                      <c:set var = "str1" value = "${fn:substringAfter(upcomingWebinar.files, '.')}" />
														
															<c:if test = "${not empty upcomingWebinar.files}">
															<c:if test = "${fn:substringAfter(upcomingWebinar.files, '.') == 'jpg'}">
																 
															
															<img style="width:75%;" src="https://d1iy5wifs53qnq.cloudfront.net/${upcomingWebinar.files}" >	
																</c:if>
													       ...
													       <c:if test = "${not empty upcomingWebinar.files}">
															...
															<img style="width:75%;" src="https://d1iy5wifs53qnq.cloudfront.net/${upcomingWebinar.files}" >	
                                                                 ...
                                                                 <c:if test = "${not empty upcomingWebinar.files}">
															<c:if test = "${fn:substringAfter(upcomingWebinar.files, '.') == 'png'}">
