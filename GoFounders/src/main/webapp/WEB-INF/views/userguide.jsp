...
<title> User Guide | GoFounders</title>
...
<body  class="userguide user_body">  
    <!-- Sidenav -->
                ...
                <div class="container-fluid">
                      ...
                      <!-- Brand -->
                       ...
                       <div class="navbar-wrapper">
                            <a class="navbar-brand text-white">User Guide</a>
                       </div>
                    ...
                    <div class="tab-content mb-3">
                         <div class="modal-content">
                            <div class="modal-header">
                                <h3 class="modal-title text-capitalized" id="exampleModalLabel">User's Guide</h3>

                            </div>
                            <div class="modal-body">
                                <div class='u-body'>
                                    <img src="https://d1iy5wifs53qnq.cloudfront.net/Users_Guide_final.jpg" alt="" class="img-fluid">
...
</div><input type="hidden" name="userid" id="userid" value="7364">
