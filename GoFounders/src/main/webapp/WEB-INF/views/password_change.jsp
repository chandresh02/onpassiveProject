...
<title> User Password Change | GoFounders</title>
                ...
                <div class="container-fluid">
                      ...
                      <!-- Brand -->
                       ...
                       <div class="navbar-wrapper">
                            <a class="navbar-brand text-white">User password change</a>
                       </div>
      ...
      <div class="container" style="margin-top: -68px;">
        ...
        <div class="row" style="margin-left: -7px;">
          ...
          <div class="col-lg-7 col-md-10" >
            ...
            <h1 class="display-2 text-white">Hello Tanmoy</h1>
        ...
        <div class="col-lg-6">
            ...
            <div class="card">
             ...
             <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Change Your Current Password Here</p>
                </div>
          ...
          <div class="card-body pb-4">
                ...
                <form class="mb-0" method="post" action="#" style="">               
                      ...
                      <div class="form-group">
                        ...
                        <label class="bmd-label-floating" for="input-username">Enter New Password</label>

                        <input type="password" id="input-username" name="password" class="form-control"  value="" required="">

                      </div>

                        <div class="form-group">

                        <label class="bmd-label-floating" for="input-username">Confirm New Password</label>

                        <input type="password" id="input-username" name="cpassword" class="form-control"  value="" required="">
                    ...
                    <input type="hidden" name="huserid" value="7364">
