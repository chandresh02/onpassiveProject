...
<head>
    ...
    <script src="http://3.215.252.44/assests/meterial/assets/js/material-dashboard.js?v=2.1.1"
                ...
                <div class="sidebar-wrapper" id="g-toogler">
                    <ul class="nav" style="">
                        <li class="nav-item active">
                            <a class="sidebar-link" href="http://3.215.252.44/users/dashboard">
                        ...
                        <li class="nav-item ">
                            <a class="sidebar-link" href="http://3.215.252.44/user_profile">
                                <span class="icon-holder">
                        ...
                        <li class="nav-item ">
                            <a class="sidebar-link" href="http://3.215.252.44/announcements">
                                <span class="icon-holder">
                        ...
                        <li class="nav-item ">
                            <a class="sidebar-link " href="http://3.215.252.44/community">
                                <span class="icon-holder">
                        ...
                        <li class="nav-item ">
                            <a class="sidebar-link" href="http://3.215.252.44/webinars">
                                <span class="icon-holder">
                        ...
                        <li class="nav-item ">
                            <a class="sidebar-link" href="http://3.215.252.44/user_link">
                                <span class="icon-holder">
                        ...
                        <li class="nav-item ">
                            <a class="sidebar-link" href="http://3.215.252.44/download">
                                <span class="icon-holder">
                        ...
                        <li class="nav-item ">
                            <a class="sidebar-link" href="http://3.215.252.44/invitations">
                                <span class="icon-holder">
                        ...
                        <li class="nav-item ">
                            <a class="sidebar-link" href="http://3.215.252.44/invitees/index/?info=10">
                                <span class="icon-holder">
                        ...
                        <li class="nav-item ">
                            <a class="sidebar-link" href="http://3.215.252.44/member/index/?info=10">
                                <span class="icon-holder">
                        ...
                        <li class="nav-item ">
                            <a class="sidebar-link" href="http://3.215.252.44/alfounders">
                                <span class="icon-holder">
                        ...
                        <li class="nav-item ">
                            <a class="sidebar-link" href="http://3.215.252.44/users/leaderboard">
                                <span class="icon-holder">
                        ...
                        <li class="nav-item ">
                            <a class="sidebar-link" href="http://3.215.252.44/marketing">
                                <span class="icon-holder">
                        ...
                        <li class="nav-item ">
                            <a class="sidebar-link " href="http://3.215.252.44/tutorials">
                                <span class="icon-holder">
                        ...
                        <li class="nav-item ">
                            <a class="sidebar-link " href="http://3.215.252.44/testimonials">
                                <span class="icon-holder">
                        ...
                        <li class="nav-item ">
                            <a class="sidebar-link" href="http://3.215.252.44/faq">
                                <span class="icon-holder">
                        ...
                        <li class="nav-item ">
                            <a class="sidebar-link" href="http://3.215.252.44/support">
                                <span class="icon-holder">
                        ...
                        <ul class="navbar-nav notification-menu">
                            ...
                            <li class="nav-item dropdown community-list-item" id="ul_community_head_id">
                                ...
                                <span class="total-notifiocation" id="com_count_total_not">
                                    33</span>
                                <a class="position-relative notification-icon community-notifiocation"
                                    id="communitynavdropdown" href="#" data-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">
                                ...
                                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right py-0 overflow-hidden"
                                    ...
                                    <div class="notification-row " id="notify_com_popup_bx">
                                        ...
                                        <div class="px-3 py-3" id="com_noti_headlines">
                                            ...
                                            <h6 class="text-sm text-muted m-0">New <strong
                                                    class="text-primary inviteesnoti" id="count_community">12</strong>
                                                communities posted by <span>Administrator</span></h6>
                                            <h6 class="text-sm text-muted m-0">You have <strong id="count_comment_reply"
                                                    class="text-primary inviteesnoti">7</strong> New replies for
                                                <span>Comments</span></h6>
                                            <h6 class="text-sm text-muted m-0">You have <strong
                                                    class="text-primary inviteesnoti"
                                                    id="count_comment_likes">14</strong> New likes for
                                                <span>Comments</span></h6>
                                            ...
                                            <ul id="all_ul">
                                                <li onclick="fn_update_comment_like('101950', '29980');"> <span
                                                    ...
                                                    <a href="javascript:void(0);"
                                                        ...
                                                        <h7>Your comment is liked by</h7> <span>John E. Stratmann</span>
                                                        <h7>Posted on :</h7> <label>
                                                ...
                                                <li onclick="fn_update_comment_like('101845', '29980');"> <span
                                                    ...
                                                    <a href="javascript:void(0);"
                                                        ...
                                                        <h7>Your comment is liked by</h7> <span>Debra Baxter</span>
                                                        <h7>Posted on :</h7> <label>
                                                            08:08pm on Friday, June 28th, 2019</label>
                                                    </a>
                                                </li>
                                                <li onclick="fn_update_reply('11713', '29980');">
                                                    <span class="notif-thumb mt-2"
                                                    ...
                                                    <a href="javascript:void(0);"
                                                        ...
                                                        <h7>A reply for a comment is posted by</h7> <span>Willie Lewis
                                                            Combs</span>
                                                        <h7>Posted on :</h7> <label>
                                                ...
                                                <li onclick="fn_update_reply('11707', '29980');">
                                                    ...
                                                    <a href="javascript:void(0);"
                                                        ...
                                                        <h7>A reply for a comment is posted by</h7> <span>Colin
                                                            Stein</span>
                                                        <h7>Posted on :</h7> <label>
                                                ...
                                                <li onclick="fn_update_comment_like('101713', '29980');"> <span
                                                        class="notif-thumb  mt-2">AT</span> <a
                                                        href="javascript:void(0);"
                                                        class="comment_like_101713 comment-like-new-popup" id="101713">
                                                        <h7>Your comment is liked by</h7> <span>Alayne Tribolet</span>
                                                        <h7>Posted on :</h7> <label>
                                                ...
                                                <li onclick="fn_update_comment_like('101671', '29980');"> <span
                                                    ...
                                                    <a href="javascript:void(0);"
                                                        ...
                                                        <h7>Your comment is liked by</h7> <span>Angela Nycz</span>
                                                        <h7>Posted on :</h7> <label>
                                                ...
                                                <li onclick="fn_update_comment_like('101539', '29980');"> <span
                                                    ...
                                                    <a href="javascript:void(0);"
                                                        ...
                                                        <h7>Your comment is liked by</h7> <span>LaVonne Johnson</span>
                                                        <h7>Posted on :</h7> <label>
                                                ...
                                                <li onclick="fn_update_comment_like('101533', '29980');"> <span
                                                    ...
                                                    <a href="javascript:void(0);"
                                                        ...
                                                        <h7>Your comment is liked by</h7> <span>Matt Mihalicz</span>
                                                        <h7>Posted on :</h7> <label>
                                                ...
                                                <li onclick="fn_update_reply('11692', '29980');">
                                                    ...
                                                    <a href="javascript:void(0);"
                                                        ...
                                                        <h7>A reply for a comment is posted by</h7> <span>Robert James
                                                            Guenther</span>
                                                        <h7>Posted on :</h7> <label>
                                                ...
                                                <li onclick="fn_update_comment_like('101501', '29980');"> <span
                                                    ...
                                                    <a href="javascript:void(0);"
                                                        ...
                                                        <h7>Your comment is liked by</h7> <span>Clara Nolt</span>
                                                        <h7>Posted on :</h7> <label>
                                                ...
                                                <li onclick="fn_update_comment_like('101492', '29980');"> <span
                                                        class="notif-thumb  mt-2"
                                                        style="background:url(https://d1iy5wifs53qnq.cloudfront.net/2039246632Timm Guitar3.jpg)"></span>
                                                    <a href="javascript:void(0);"
                                                        class="comment_like_101492 comment-like-new-popup" id="101492">
                                                        <h7>Your comment is liked by</h7> <span>Timm Johnson</span>
                                                        <h7>Posted on :</h7> <label>
                                                ...
                                                <li onclick="fn_update_reply('11684', '29980');">
                                                    ...
                                                    <a href="javascript:void(0);"
                                                        ...
                                                        <h7>A reply for a comment is posted by</h7> <span>James
                                                            Williams</span>
                                                        <h7>Posted on :</h7> <label>
                                                ...
                                                <li onclick="fn_update_reply('11681', '29980');">
                                                    ...
                                                    <a href="javascript:void(0);"
                                                        ...
                                                        <h7>A reply for a comment is posted by</h7> <span>Pierre
                                                            Nortier</span>
                                                        <h7>Posted on :</h7> <label>
                                                ...
                                                <li onclick="fn_update_reply('11672', '29980');">
                                                    ...
                                                    <a href="javascript:void(0);"
                                                        ...
                                                        <h7>A reply for a comment is posted by</h7> <span>Victoria
                                                            Leal</span>
                                                        <h7>Posted on :</h7> <label>
                                                ...
                                                <li onclick="fn_update_comment_like('101354', '29980');"> <span
                                                    ...
                                                    <a href="javascript:void(0);"
                                                        ...
                                                        <h7>Your comment is liked by</h7> <span>Valerie Griffith</span>
                                                        <h7>Posted on :</h7> <label>
                                                ...
                                                <li onclick="fn_update_reply('11666', '29980');">
                                                    ...
                                                    <a href="javascript:void(0);"
                                                        ...
                                                        <h7>A reply for a comment is posted by</h7> <span>Stuart
                                                            Clark</span>
                                                        <h7>Posted on :</h7> <label>
                                                ...
                                                <li onclick="fn_update_comment_like('101315', '29980');"> <span
                                                    ...
                                                    <a href="javascript:void(0);"
                                                        ...
                                                        <h7>Your comment is liked by</h7> <span>Michael Carden</span>
                                                        <h7>Posted on :</h7> <label>
                                                ...
                                                <li onclick="fn_update_comment_like('101304', '29980');"> <span
                                                    ...
                                                    <a href="javascript:void(0);"
                                                        ...
                                                        <h7>Your comment is liked by</h7> <span>Laszlo Szabo</span>
                                                        <h7>Posted on :</h7> <label>
                                                ...
                                                <li onclick="fn_update_comment_like('101300', '29980');"> <span
                                                    ...
                                                    <a href="javascript:void(0);"
                                                        ...
                                                        <h7>Your comment is liked by</h7> <span>Mr. Ash</span>
                                                        <h7>Posted on :</h7> <label>
                                                ...
                                                <li onclick="fn_update_comment_like('101286', '29980');"> <span
                                                    ...
                                                    <a href="javascript:void(0);"
                                                        ...
                                                        <h7>Your comment is liked by</h7> <span>Pongrac Gal</span>
                                                        <h7>Posted on :</h7> <label>
                                                ...
                                                <li onclick="fn_update_comment_like('101283', '29980');"> <span
                                                    ...
                                                    <a href="javascript:void(0);"
                                                        ...
                                                        <h7>Your comment is liked by</h7> <span>Mpumelelo Khumalo</span>
                                                        <h7>Posted on :</h7> <label>
                                                ...
                                                <li onclick="fn_update_community('1045971', '29980');">
                                                    ...
                                                    <span class="notif-thumb mt-2"></span>

                                                    <a href="javascript:void(0);"
                                                        class="poscom_1045971 community-new-popup" id="1045971">
                                                        <h7>Adminstrator posted community</h7> <span>
                                                            <p><span style="font-size:24px;">The <strong>BEST DAYS
                                                                    </strong>in our Life are ahead</span></p>
                                                        </span>
                                                        <h7> Posted on :</h7> <label>
                                                    ...
                                                    <a href="javascript:void(0);"
                                                        ...
                                                        <h7>Adminstrator posted community</h7> <span>
                                                            <p><span style="font-size:20px;">To Our&nbsp;Fellow
                                                                    Americans...Founders and Families&nbsp;</span></p>
                                                        </span>
                                                        <h7> Posted on :</h7> <label>
                            ...
                            <li class="nav-item dropdown n-menu">
                                ...
                                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right py-0 overflow-hidden">
                                    ...
                                    <div class="notification-row">
                                        ...
                                        <div class="list-group list-group-flush">
                                            ...
                                            <ul>
                                                ...
                                                <a href="javascript:void(0);" class="addDetails1" id="79220">
                                                    <li>

                                                        Your new invitees is <span>tanvi kazi</span>
                                                    </li>

                                                </a>

                                                <input type="hidden" name="" id="inviteesidlist" value="79220">
                                            </ul>
                                    ...
                                    <div class="notification-row">
                                        ...
                                        <div class="px-3 py-3">
                                            <h6 class="text-sm text-muted m-0">You have <strong
                                                    class="text-primary">0</strong> notifications from
                                                <span>Webinar</span></h6>
                                        </div>
                                    ...
                                    <div class="notification-row">
                                        ...
                                        <div class="px-3 py-3">
                                            <h6 class="text-sm text-muted m-0">You have <strong
                                                    class="text-primary">123</strong> notifications from
                                                <span>Download</span></h6>
                                        </div>
                                        ...
                                        <div class="list-group list-group-flush">
                                            ...
                                            <ul>
                                                ...
                                                <a href="javascript:void(0);" class="addDetailsdownload" id="159">
                                                    <li>
                                                ...
                                                <a href="javascript:void(0);" class="addDetailsdownload" id="160">
                                                    <li>
                                                ...
                                                <a href="javascript:void(0);" class="addDetailsdownload" id="161">
                                                    <li>
                            ...
                            <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true"
                                ...
                                <div class="media align-items-center">
                                    ...
                                    <span class="avatar avatar-sm rounded-circle avatar-bg"
                                        ...
                                        <!--<img src="http://3.215.252.44/uploads/8561705301118697793saikat.jpg"
                                              width="50px" height="35px">-->
                                    </span>
                                    <div class="media-body ml-2">
                                        <span class="mb-0 text-sm  font-weight-bold text-white">Saikat&nbsp;
                                            Bose</span>
                                    </div>
                    ...
                    <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12">
                                ...
                                <a href="http://3.215.252.44/announcements" data-toggle="tooltip" data-placement="top"
                                    title="View More">

                                    <div class="layers-body layer4">
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-lg-5">
                                                ...
                                                <div class="layer-thumb text-center">
                                                    ...
                                                    <img src="http://3.215.252.44/assests/css/img/icon/1.png" alt=""
                                                        class="img-fluid">
                                            ...
                                            <div class="col-lg-7">
                                                ...
                                                <div class="layer-content">
                                                    ...
                                                    <h4 class="">Announcements <img
                                                            src="http://3.215.252.44/assests/img/layers/view.png" alt=""
                                                            class="img-fluid"></h4>

                                                    <h1 class="total-founders Single">

                                                        <span class="counter1 total-founders Single" data-count="34">
                            ...
                            <div class="col-md-4 col-sm-12">
                                ...
                                <a href="http://3.215.252.44/webinars" data-toggle="tooltip" data-placement="top"
                                    title="View More">

                                    <div class="layers-body layer2">
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-lg-5">
                                                ...
                                                <div class="layer-thumb text-center">
                                                    ...
                                                    <img src="http://3.215.252.44/assests/css/img/icon/2.png" alt=""
                                                        class="img-fluid">
                                            ...
                                            <div class="col-lg-7">
                                                ...
                                                <div class="layer-content">
                                                    ...
                                                    <h4 class="">Webinars
                                                        ...
                                                        <img src="http://3.215.252.44/assests/img/layers/view.png"
                                                            alt="" class="img-fluid">
                                                    ...
                                                    <h1 class="total-founders Single">
                                                        ...
                                                        <span class="counter1 total-founders Single" data-count="73">
                            ...
                            <div class="col-md-4 col-sm-12">
                                ...
                                <a href="http://3.215.252.44/invitees/index/?info=10" data-toggle="tooltip"
                                    data-placement="top" title="View More">

                                    <div class="layers-body layer3">
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-lg-5">
                                                ...
                                                <div class="layer-thumb text-center">
                                                    ...
                                                    <img src="http://3.215.252.44/assests/css/img/icon/3.png" alt=""
                                                        class="img-fluid">
                                            ...
                                            <div class="col-lg-7">
                                                ...
                                                <div class="layer-content">
                                                    ...
                                                    <h1 class="total-founders Single">
                                                        ...
                                                        <span class="counter1 total-founders Single" data-count="1">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12">
                                ...
                                <a href="http://3.215.252.44/member/index/?info=10" data-toggle="tooltip"
                                    data-placement="top" title="View More">

                                    <div class="layers-body layer6">
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-lg-5">
                                                ...
                                                <div class="layer-thumb text-center">
                                                    ...
                                                    <img src="http://3.215.252.44/assests/css/img/icon/4.png" alt=""
                                                        class="img-fluid">
                            ...
                            <div class="col-md-4 col-sm-12">
                                ...
                                <a href="http://3.215.252.44/community" data-toggle="tooltip" data-placement="top"
                                    title="View More">

                                    <div class="layers-body layer1">
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-lg-5">
                                                ...
                                                <div class="layer-thumb text-center">
                                                    ...
                                                    <img src="http://3.215.252.44/assests/css/img/icon/5.png" alt=""
                                                        class="img-fluid">
                                            ...
                                            <div class="col-lg-7">
                                                ...
                                                <div class="layer-content">
                                                    ...
                                                    <h4 class="">Community <img
                                                            src="http://3.215.252.44/assests/img/layers/view.png" alt=""
                                                            class="img-fluid" /></h4>

                                                    <h1 class="total-founders Single">

                                                        <span class="counter1 total-founders Single" data-count="90">
                            ...
                            <div class="col-md-4 col-sm-12 livedata">

                                <a href="">

                                    <div class="layers-body layer5">
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-lg-5">
                                                ...
                                                <div class="layer-thumb text-center">
                                                    ...
                                                    <img src="http://3.215.252.44/assests/css/img/icon/6.png" alt=""
                                                        class="img-fluid">
                                            ...
                                            <div class="col-lg-7">
                                                ...
                                                <div class="layer-content ">
                                                    ...
                                                    <h1 class="total-founders Single">
                                                        ...
                                                        <span class="counter total-founders Single"
                                                            data-count="">36906</span>
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-md-4 col-sm-12 buttons" style="">

                                    <a href="http://3.215.252.44/users/leaderboard">
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-lg-7">
                                                    ...
                                                    <div class="layer-content">
                                                        ...
                                                        <h4 class="">Leaderboard <img src="http://3.215.252.44/assests/img/layers/view.png" alt="" class="img-fluid"/></h4>
