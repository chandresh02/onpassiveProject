             ...
             60% {
              ...
              <div class="card pt-4">
                             ...
                             <div class="col-lg-12">
                                <div class="mid_box">
                                   <a href="#" class="main-a-tree">
                                                                            <div class='profilepic' style="background-image:url('https://d1iy5wifs53qnq.cloudfront.net/8561705301118697793saikat.jpg')">
                                      </div>
                                                                            <div class="treecname pname tooltip" style="">
                                         Saikat&nbsp;Bose                                         <div class='top'>
                                                                                        <div class='profilepic' style="background-image:url('https://d1iy5wifs53qnq.cloudfront.net/8561705301118697793saikat.jpg')">
                                            </div>
                                                                                        <h3 style="color: #000;"><strong>
                                               Saikat&nbsp;Bose</strong>
                                            </h3>
                                            <h4 style="text-align: left; "> <strong> Join
                                               Date:</strong>&nbsp;<span
                                                  style="text-transform: capitalize;">Apr 03, 2019</span>
                                            </h4>
                                               ...
                                               <strong>Country:</strong>&nbsp;<span
                                                  style=""><img
                                                  id="pic"
                                                  src="https://www.gofounders.net/assests/flags/IN-128.png"
                                                  width="40">&nbsp;India</span>
                                            </h4>
                                            <h4 style="text-align: left;">
                                               <strong>Saikat's                                               Team:</strong> <span style="">1</span>
                                            </h4>
                                         </div>
                                      </div>
                                   </a>
                                ...
                                <!-- Tab panes -->
                                <div class="tab-content mb-3" style="overflow-y:hidden">
                                      ...
                                      <div class="tree">
                                         <ul>
                                            <li class="">
                                               <ul>
                                                                                                                                                      <li>
                                                     <a href="http://3.215.252.44/allfounders/childfounders/MjcxODA=" class="profilepicture-a">
                                                                                                                <div class='profilepicture avatar avatar-sm rounded-circle'
                                                           id='profileImage1'>
                                                           sd                                                        </div>
                                                        <div class="treecname pname tooltip" style="">
                                                           sachin&nbsp;deoo                                                           <div class='top'>
                                                              <div class='profilepicture avatar avatar-sm rounded-circle'
                                                                 id='profileImage1'>
                                                                 sd                                                              </div>
                                                              <h3 style="color: #000;"> <strong>
                                                              ...
                                                              <h4 style="text-align: left; "><strong>Join
                                                                 Date:</strong>&nbsp;<span
                                                                    style="text-transform: capitalize;">Mar 19, 2019</span>
                                                              </h4>
                                                              <!--                                                                        <h4 style="text-align: left; ">
                                                                 <strong>Email:</strong>&nbsp;<span
                                                                     style="text-transform: lowercase;">sachindeo1995@gmail.com</span>
                                                                 </h4>-->
                                                              <h4 style="text-align: left; ">
                                                                 <strong>Country:</strong>&nbsp;<span
                                                                    style=""><img
                                                              ...
                                                              <h4 style="text-align: left;">
                                                                 <strong>sachin's                                                                 Team: </strong><span style="">0</span>
                                                              </h4>
                                                           </div>
                                                        </div>
                                                                                                             </a>
                          ...
                          <div class="col-sm-12 text-center">
                            <a href="http://3.215.252.44/allfounders" style="padding: 0px" class="go_back_button">
                       <img src="https://www.gofounders.net/assests/emoji/img/arrow_three.png" class="go_back_icon"> 
                       <div class="go_text">Go Back</div>
                    </a>
                                                                      
                    <a href="http://3.215.252.44/allfounders/childfounders/NzM2NA=="
                       class="btn-just-icon lavel-up-btn  arrow btn btn-success btn-not-fluid" title="Back One Level">
