                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-11 ">
                                    ...
                                    <h4 class="text-uppercase font-weight-bold text-center mt-4">Resend login Information</h4>
                                                      ...
                                                      <form class="form-horizontal mt-5" action="https://www.gofounders.net/users/resendlogin_update" method="post">
                                        <fieldset>
                                            <div class="row">

                                                <div class="form-group col-12">
                                                    <input id="email"  name="send_mail" type="email" placeholder="Email Address"
