...
.content-placeholder {
	...
	background: #f6f7f8;
	background: -webkit-gradient(linear, left top, right top, color-stop(8%, #eeeeee),
		color-stop(18%, #dddddd), color-stop(33%, #eeeeee));
...
@media ( max-width : 576px) {
                                        ...
                                        <input type="hidden" name="file" value="34K.jpg">
												...
												<c:forEach items="${data}" var="announce">
													...
													<div class="post-boxes">
														<div class="row align-items-center">
															<div class="col-lg-6">
													<c:set var = "str1" value = "${fn:substringAfter(announce.files, '.')}" />
														
															<c:if test = "${not empty announce.files}">
															<c:if test = "${fn:substringAfter(announce.files, '.') == 'mp4'}">
																 	<video id="my-video" class="video-js video-size w-70"
																	controls preload="auto"
																	poster="https://d1iy5wifs53qnq.cloudfront.net/${announce.poster}"
																	data-setup="{}">
																	<source
																		src="https://d1iy5wifs53qnq.cloudfront.net/${announce.files}"
																		type='video/mp4'>
  ...
  <script src="http://3.215.252.44/assests/js/video.min.js"></script>
																</c:if>
																
 			<%-- 												<c:if test = "${fn:substringAfter(announce.files, '.') == 'jpg'}"> --%>
															 <c:if test = "${fn:substringAfter(announce.files, '.') != 'mp4'}">
																 	<img style=""
																	src="https://d1iy5wifs53qnq.cloudfront.net/${announce.files}"
																	class="img-responsive  w-70">
															 </c:if>
															 </c:if>

																
												<%-- 				<h2>Data is ${announce.files}</h2> --%>
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="col-lg-12">
                                                     ...
                                                     <div class="post-title">
                                                        <h2>ONPASSIVE is a worldwide business, in every country on the planet.. except.. </h2>
                                                     </div>
